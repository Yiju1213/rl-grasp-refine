...
class SGAGSNEncoder(BaseBackbone):
    """Minimal summary-based encoder used as a stable v1 placeholder."""
    ...
    def forward(self, **kwargs) -> torch.Tensor:
        ...
        point_summary = _summarize_tensor(point_cloud, batch_size, target_dim=6)
        tactile_summary = _summarize_tensor(tactile, batch_size, target_dim=6)
        features = torch.cat([point_summary, tactile_summary], dim=1)
